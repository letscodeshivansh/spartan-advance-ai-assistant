...
st.set_page_config(page_title="Efficient, Reliable, Spartan")
st.header("Efficient, Reliable, Spartan")
...
image_path = 'assets/spartan2.jpg'
st.image(image_path, caption='Hi this is your Spartan', width=250)


if __name__ == "__main__":
    st.write("Let me know your issue !")
