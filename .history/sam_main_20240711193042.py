# Creating SAM( Smart Assistance Machine)
about='''My name is SAM( Smart Assistance Machine). I am a virtual assistant,
that can help you with your basics task, such as opening websites, youtube,
searching the results from the web and a lot more. I have been created by the Python Developer,
"Mr. Dheeraj Dhawan", as a project for the 6 weeks training.'''
