...
# Dropdown to select language/voice
voice_choice = st.selectbox("English (US)", ["English (US)", "English (UK)", "French", "German", "Spanish"])

# Map voice choice to gTTS language codes
voice_map = {
    "English (US)": "en",
    "English (UK)": "en-uk",
    "French": "fr",
...
selected_voice = en[voice_choice]
...
with st.expander("Assistant Response"):
    if text_query:
        st.write(f"Typed response: {response}")
